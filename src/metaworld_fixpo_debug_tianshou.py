...
def get_args():
    ...
    parser.add_argument("--gen-plots", type=int, default=0)
    parser.add_argument("--gen-behavior", type=int, default=0)
    parser.add_argument(
        "--logger",
        type=str,
        default="wandb",
...
def run_fixpo(args=get_args()):
    ...
    policy = FixPOPolicy(
        ...
        gen_plots=bool(args.gen_plots),
        gen_behavior=bool(args.gen_behavior),
    )
